# -*- coding: utf-8 -*-
"""Portefeuille Offensif avec ASIE"""
...
def simulate_portfolio(monthly_investment=100, initial_investment=10000):
    """
    Simule un portefeuille offensif avec une exposition Asie, avec DCA et investissement initial.
    ...
    Returns:
        dict: Résultats de la simulation et DataFrame des valeurs simulées.
    """
    ...
    def preprocess_data(df, column_name, start_date, fee_rate):
        ...
        daily_fee_rate = (1 - fee_rate / 100) ** (1 / 252)
    ...
    # Appliquer le prétraitement avec frais
    for key, df in dfs.items():
        dfs[key] = preprocess_data(df, key, start_date, frais[key])
