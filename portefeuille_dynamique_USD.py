...
dfs = [df_treasury, df_short_duration, df_sp500, df_nasdaq, df_small_cap, df_mid_cap]
df_combined = dfs[0]
for df in dfs[1:]:
...
weights = {
    'VL_Treasury': 0.20,       # US Treasury Bond
    'VL_Short_Duration': 0.10, # US Short Duration
    'VL_SP500': 0.40,          # S&P 500
    'VL_Nasdaq': 0.0,         # Nasdaq
    'VL_Small_Cap': 0.15,      # Small Cap
    'VL_Mid_Cap': 0.15,        # Mid Cap
}
