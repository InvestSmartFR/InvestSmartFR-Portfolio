# -*- coding: utf-8 -*-
"""Portefeuille Pondéré MIXTE Asie"""
...
def simulate_portfolio(monthly_investment=100, initial_investment=10000):
    """
    Simule le portefeuille pondéré mixte avec une exposition à l'Asie, en prenant en compte l'investissement initial et DCA.
    ...
    def preprocess_data(df, column_name):
        """
        Prépare les données : conversion de date, tri, renommage des colonnes.
        """
    ...
    # Limiter les données à partir d'une date de départ
    ...
    def apply_fees(df, frais):
        """
        Ajuste les VL en fonction des frais annuels.
        """
        days_in_year = 365.25
