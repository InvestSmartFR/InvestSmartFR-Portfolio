...
def simulate_portfolio(monthly_investment=100, initial_investment=10000):
    """
    Simule le portefeuille pondéré USD, en prenant en compte l'investissement initial et les contributions mensuelles (DCA).
    ...
    weights = {
        'US Treasury Bond': 0.38,
        'US Short Duration': 0.12,
        'S&P 500': 0.20,
        'Nasdaq': 0.20,
        'Small Cap': 0.10,
    }
